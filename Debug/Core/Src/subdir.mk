...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/audio_fs.cyclo ./Core/Src/audio_fs.d ./Core/Src/audio_fs.o ./Core/Src/audio_fs.su ./Core/Src/display.cyclo ./Core/Src/display.d ./Core/Src/display.o ./Core/Src/display.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/stm32f4xx_hal_msp.cyclo ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_it.cyclo ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su ./Core/Src/usbh_conf.cyclo ./Core/Src/usbh_conf.d ./Core/Src/usbh_conf.o ./Core/Src/usbh_conf.su ./Core/Src/usbh_diskio_dma.cyclo ./Core/Src/usbh_diskio_dma.d ./Core/Src/usbh_diskio_dma.o ./Core/Src/usbh_diskio_dma.su
